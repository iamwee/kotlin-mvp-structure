...
fun Fragment.add(fragmentManager: FragmentManager) {
    try {
...
fun Fragment.add(fragmentManager: FragmentManager, savedInstanceState: Bundle?) {
...
fun Fragment.replace(fragmentManager: FragmentManager, savedInstanceState: Bundle?) {
    if (savedInstanceState == null) {
        try {
            fragmentManager.beginTransaction()
                    .replace(R.id.container, this)
